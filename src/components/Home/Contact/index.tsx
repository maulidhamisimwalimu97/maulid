...
const Contact = () => {
  return (
    <section className='overflow-x-hidden bg-section dark:bg-darkmode' id='contact'>
      <div className='container mx-auto max-w-6xl px-4 py-16'>
        ...
        <h2
          className='sm:text-4xl text-[28px] leading-tight font-bold text-midnight_text dark:text-white text-center pt-7 pb-4 md:w-4/6 w-full m-auto'
          data-aos='fade-up'
          data-aos-delay='200'
          data-aos-duration='1000'>
          Let's Work Together
        ...
        <p
          className='text-base text-grey dark:text-white/50 text-center pb-12 max-w-2xl mx-auto'
          data-aos='fade-up'
          data-aos-delay='300'
          data-aos-duration='1000'>
        ...
        <div className='max-w-3xl mx-auto'>
          <div className='grid md:grid-cols-2 grid-cols-1 gap-6'>
            <div
              className='bg-white dark:bg-white/5 backdrop-blur-sm rounded-xl p-8 hover:shadow-lg dark:hover:bg-white/10 transition-all duration-300'
              data-aos='fade-up'
              data-aos-delay='200'
              data-aos-duration='1000'>
              ...
              <h3 className='text-midnight_text dark:text-white text-lg font-semibold mb-2'>Phone</h3>
              <a href='tel:0742700833' className='text-grey dark:text-white/70 hover:text-primary transition-colors text-base'>
                0742700833
              </a>
            </div>
            <div
              ...
              <h3 className='text-midnight_text dark:text-white text-lg font-semibold mb-2'>Email</h3>
              <a href='mailto:hamisimaulid064@gmail.com' className='text-grey dark:text-white/70 hover:text-green-400 transition-colors text-base break-all'>
